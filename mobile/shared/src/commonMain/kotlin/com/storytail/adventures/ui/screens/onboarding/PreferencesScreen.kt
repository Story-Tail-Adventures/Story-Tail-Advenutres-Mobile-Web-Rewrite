 ...
 */
private object PreferencesCopy {
...
fun PreferencesScreen(
    ...
    OnboardingScaffold(
        ...
        Group(PreferencesCopy.STYLE, hint = PreferencesCopy.STYLE_HINT) {
            ChipRow(
        ...
        Group(PreferencesCopy.BUDGET, hint = PreferencesCopy.BUDGET_HINT) {
            ChipRow(
